...
export default function AITutorPage() {
  ...
  return (
    <div className="w-full h-full min-h-screen flex flex-col -m-4 sm:-m-6 lg:-m-8">
      <div className="bg-white shadow-lg flex-1 flex flex-col">
            ...
            <div className="flex justify-start">
              <div className="bg-white text-gray-800 border border-gray-200 px-4 py-2 rounded-lg">
                <div className="flex items-center space-x-2">
                  ...
                  <div
                    className="animate-bounce w-2 h-2 bg-purple-600 rounded-full"
        ...
        <div className="p-6 bg-white border-t border-gray-200">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">Quick Help Topics</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              {
                title: 'English Assistance',
                description: 'Writing, Literature, Grammar',
                icon: '📚',
              },
