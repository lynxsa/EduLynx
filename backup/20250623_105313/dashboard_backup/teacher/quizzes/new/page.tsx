      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div>
          ...
          {questionFields.map((q, qi) => (
            <div key={q.id} className="border p-4 mb-4 rounded bg-gray-50">
              ...
              {errors.questions?.[qi]?.text && (
                <p className="text-red-500 text-sm">{errors.questions[qi]?.text?.message}</p>
              )}
              <div className="mb-2">
                        ...
                        <div key={oi} className="flex items-center mb-1">
                          ...
                          <input
                            ...
                            checked={
                              ...
                              oi === (control._formValues.questions?.[qi]?.correctIndex || 0)
                            }
                ...
                />
                {errors.questions?.[qi]?.options && (
                  <p className="text-red-500 text-sm">{errors.questions[qi]?.options?.message}</p>
                )}
                {errors.questions?.[qi]?.correctIndex && (
                  <p className="text-red-500 text-sm">
                    {errors.questions[qi]?.correctIndex?.message}
                  </p>
                )}
              </div>
            </div>
          ...
          <button
            ...
            onClick={() =>
              appendQuestion({ text: '', options: [{ text: '' }, { text: '' }], correctIndex: 0 })
            }
          >
            Add Question
          </button>
