    ...
    <form className="flex flex-col gap-6" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="flex flex-wrap gap-4">
        ...
        <div className="flex flex-col gap-2 w-full md:w-1/4">
          ...
          {errors.supervisorId && (
            <p id="supervisorId-error" className="text-xs text-red-700">
              {errors.supervisorId.message as string}
            </p>
          )}
        </div>
        <div className="flex flex-col gap-2 w-full md:w-1/4">
          <label htmlFor="schoolId" className="text-xs text-gray-500">
            School
          </label>
          <input
            id="schoolId"
          ...
          />
          {errors.schoolId && (
            <p id="schoolId-error" className="text-xs text-red-700">
