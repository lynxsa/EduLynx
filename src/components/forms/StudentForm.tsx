    ...
    <form className="flex flex-col gap-6" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="flex flex-wrap gap-4">
        ...
        <InputField
          ...
          register={register}
          defaultValue={data?.guardianRelationship || ''}
        ...
        <InputField
          ...
          register={register}
          defaultValue={data?.extracurriculars || ''}
        ...
        <div className="flex flex-col gap-2 w-full md:w-1/4">
          <label htmlFor="parentId" className="text-xs text-gray-500">
            Parent
          </label>
          <select
            id="parentId"
          ...
          {errors.parentId && (
            <p id="parentId-error" className="text-xs text-red-700">
        ...
        <div className="flex flex-col gap-2 w-full md:w-1/4">
          ...
          {errors.gradeId && (
            <p id="gradeId-error" className="text-xs text-red-700">
