  ...
  return (
    <div className="bg-white p-3 rounded-2xl">
      <div className="flex items-center justify-between">
        ...
        <span className="text-xs text-gray-500 cursor-pointer hover:underline transition-all duration-150">
          View All
        </span>
      </div>
      ...
      <div className="flex flex-col gap-4">
        {(announcements || []).length === 0 ? (
          ...
          (announcements || []).map(announcement => (
            <div
              className="p-5 rounded-md border-2 border-gray-100-t-4 odd:border-l-LYNXPurple even:border-t-LYNXLight text-xs transition-shadow duration-200 hover:shadow-lg animate-fade-in"
              key={announcement.id}
              tabIndex={0}
