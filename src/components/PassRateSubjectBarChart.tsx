  ...
  return (
    <div className="w-full h-72 bg-white dark:bg-gray-900 rounded-2xl shadow-md p-4 flex flex-col animate-fade-in hover:shadow-xl transition-shadow duration-200">
      <div className="flex justify-between items-center mb-2">
        ...
        <div className="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded-full cursor-pointer" data-tooltip-id="passrate-tooltip" data-tooltip-content="Shows percentage of students passing each subject (≥50%)">
          📊
        </div>
      </div>
      {data.length === 0 ? (
        ...
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} margin={{ top: 10, right: 20, left: 0, bottom: 30 }}>
            ...
            <XAxis dataKey="subject" tick={{ fontSize: 12, fill: '#6b7280' }} angle={-20} textAnchor="end" interval={0} />
