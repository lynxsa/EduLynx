...
export const announcementsData = [
  {
    ...
    class: "11A",
    date: "2025-01-01",
    message: "The Math exam for Grade 11A will cover chapters 5 to 8. Ensure all students are well-prepared and have reviewed previous test papers."
  },
  {
    id: 2,
    ...
    class: "12B",
    date: "2025-01-01",
    message: "Grade 12B must submit their English Literature assignments on 'Shakespeare's Tragedies' by next Monday. Late submissions will not be accepted."
  },
  {
    id: 3,
    ...
    class: "10C",
    date: "2025-01-01",
    message: "The Physics practical for Grade 10C will be conducted in the laboratory. Please bring your lab coats and safety goggles."
  },
  {
    id: 4,
    ...
    class: "9A",
    date: "2025-01-01",
    message: "The History project on 'South African Freedom Struggles' is due next week. Students should be ready to present their findings in class."
  },
  {
    id: 5,
    ...
    class: "11B",
    date: "2025-01-01",
    message: "Grade 11B will have a surprise quiz on Organic Chemistry. Please revise the last two lessons for better preparation."
  },
  {
    id: 6,
    ...
    class: "10A",
    date: "2025-01-01",
    message: "There will be a field trip to the botanical gardens for Life Sciences students. Remember to carry water and snacks."
  },
  {
    id: 7,
    ...
    class: "9B",
    date: "2025-01-01",
    message: "A Geography test on climate change and weather patterns will be conducted for Grade 9B. Make sure you study the diagrams carefully."
  },
  {
    id: 8,
    ...
    class: "12A",
    date: "2025-01-01",
    message: "Grade 12A students will have a debate on 'The Role of Government in Economic Development'. Be prepared with your arguments."
  },
  {
    id: 9,
    ...
    class: "11C",
    date: "2025-01-01",
    message: "The Accounting assignment on 'Financial Statements' is due next week. Ensure all balance sheets are accurate and well-documented."
  },
  {
    id: 10,
    ...
    class: "10B",
    date: "2025-01-01",
    message: "The Biology dissection session will be held this Friday. Please bring your lab equipment and ensure all forms are signed by parents."
  },
];
